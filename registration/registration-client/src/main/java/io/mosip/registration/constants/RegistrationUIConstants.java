...
public class RegistrationUIConstants {
	...
	public static final String UPDATE_UIN_ENTER_NID_ALERT = "UPDATE_UIN_ENTER_NID_ALERT";
	public static final String UPDATE_UIN_NID_VALIDATION_ALERT = "UPDATE_UIN_NID_VALIDATION_ALERT";
